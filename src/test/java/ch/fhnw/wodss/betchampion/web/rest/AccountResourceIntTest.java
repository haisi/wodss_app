...
import ch.fhnw.wodss.betchampion.web.rest.vm.KeyAndPasswordVM;
import ch.fhnw.wodss.betchampion.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testActivateAccount() throws Exception {
        ...
        user.setPassword(RandomStringUtils.random(96));
    ...
    public void testSaveExistingEmail() throws Exception {
        ...
        anotherUser.setPassword(RandomStringUtils.random(96));
